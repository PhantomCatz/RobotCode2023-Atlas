...
{	
    ...
    private final String LOG_HDR_INTAKE = "time,current-angle,intakeStowCount,mtr-pwr-cmd,intake-motor-output-percent,intakePivotShootCounter,intakeShooterCounter,intakeStowPower,angleError";
