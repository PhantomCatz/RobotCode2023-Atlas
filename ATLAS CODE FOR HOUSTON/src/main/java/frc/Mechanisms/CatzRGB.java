...
public class CatzRGB 
{
    ...
    public ColorMethod oneColorFillAllianceColor = (color) -> {
        fillLEDBuffer(booleanToAllianceColor(Robot.paths.chosenAllianceColor.getSelected()));
    };
    ...
    public Color booleanToAllianceColor(boolean color){
        if(color == CatzConstants.BLUE_ALLIANCE){
            return Color.kBlue;
        }
        else{
            return Color.kRed;
