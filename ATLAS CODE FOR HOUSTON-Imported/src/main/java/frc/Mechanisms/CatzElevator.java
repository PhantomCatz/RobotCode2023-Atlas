...
public class CatzElevator
{
    ...
    private final double MANUAL_HOLD_STEP_SIZE = 5000.0;
    ...
    private final double ERROR_ELEVATOR_THRESHOLD = 1000;

    private final double NO_TARGET_POSITION = -999999.0;

    private int elevatorMovementMode = Robot.MODE_AUTO;
    ...
    *----------------------------------------------------------------------------------------*/
    ...
    public int getElevatorMovementMode()
    {
        return elevatorMovementMode;
    }
